...
; Any new functions defined for the function set must be added to this namespace
(define eval-ns (make-base-namespace))

; TODO: support functions of arities other than 2
(define function-set
  '(+ - *))

; TODO: allow terminals with different probabilities of occuring in random-terminal
(define terminal-set
  '(x x x 1 2 3 4 5 6 7 8 9))

; For any serious use of symbolic regression, we would load a set of points instead of generating them
...
; TODO: implement some of the fancier mutation operators
(define (mutate tree)
...
; Creates a mixture of full and uneven trees of depths 2-6
...
; You may use any variable you like in your program, so long as its name is x
; TODO: like seriously, ugh
...
; Finds the n most fit programs in a cohort
; TODO: do this a better way, probably
...
; Don't call it with a bound of 1, that would be bad
...
; Let's include hill climbing as an alternative to gp, why not?
(define hill-climb
